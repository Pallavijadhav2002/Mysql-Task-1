...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-01-05 07:44:12',NULL),('diagnostics.include_raw','OFF','2025-01-05 07:44:12',NULL),('ps_thread_trx_info.max_length','65535','2025-01-05 07:44:12',NULL),('statement_performance_analyzer.limit','100','2025-01-05 07:44:12',NULL),('statement_performance_analyzer.view',NULL,'2025-01-05 07:44:12',NULL),('statement_truncate_len','64','2025-01-05 07:44:12',NULL);
...
-- Dump completed on 2025-02-11 17:38:40
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: scm20
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `departments` VALUES (1,'Human Resources','New York'),(2,'Engineering','San Francisco'),(3,'Finance','Chicago');
...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`DepartmentID`) REFERENCES `departments` (`DepartmentID`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employees` VALUES (1,'Alice Johnson','alice@example.com','HR Manager',75000.00,1,'2023-06-10'),(2,'Bob Smith','bob@example.com','Software Engineer',90000.00,2,'2022-08-15'),(3,'Charlie Davis','charlie@example.com','Accountant',65000.00,3,'2021-12-01');
...
INSERT INTO `salaries` VALUES (1,1,75000.00,'2023-06-10'),(2,2,90000.00,'2022-08-15'),(3,3,65000.00,'2021-12-01');
